...
HD_PWD='/home/szar/drexel/2017-fall/ecec661/bubble-sort/bubble_sort/bubble_sort.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_sorter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_sorter.tcl -notrace
