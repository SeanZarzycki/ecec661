...
HD_PWD='/home/szar/drexel/2017-fall/ecec661/bubble-sort/bubble_sort/bubble_sort.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_sorter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_sorter.tcl
